...
function tonni_tm_testimonials(){
	...
	var placeholderIMG	= '<img src="img/thumbs/1-1.jpg" alt="" />';
	...
	var images	= "";
	var names	= "PRERNA GATTANI";
	var jobs	= "Developer & Designer";
	var quotes	= "";
	var avatars	= "";
	...
	list.each(function(){
		...
		names+='<li class="'+active+'" data-index="'+count+'"><h3>'+names+'</h3></li>';
		jobs+='<li class="'+active+'" data-index="'+count+'"><span>'+jobs+'</span></li>';
	...
	testimonials.find('.testimonials_inner').append('<div class="rightpart"><div class="rightpart_in"></div></div>').find('.rightpart_in').append('<div class="main_title"><h3><span class="big">'+title+'<span class="small">'+title+'<img class="svg" src="img/thumbs/e1.png" alt="" /></span></span></h3></div><div class="quotes"><ul>'+quotes+'</ul></div><div class="details"><div class="infos"><div class="avatars"><ul class="grid-sort">'+avatars+'</ul></div><div class="short"><ul class="name">'+names+'</ul><ul class="job">'+jobs+'</ul></div></div></div>');
